...
$sql_filt = "SELECT * FROM inventario WHERE id_usuario = ? AND tags LIKE ? AND tipo_objeto='videojuego' ORDER BY id_objeto DESC LIMIT ?, ?";
$sql_no_filt = "SELECT * FROM inventario WHERE id_usuario = ? AND tipo_objeto='videojuego' ORDER BY id_objeto DESC LIMIT ?, ?";
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li class="centro active"><a href="videojuegos.php">Videojuegos</a></li>
